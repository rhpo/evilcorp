namespace EvilCorp
{
    partial class DictionaryAttackForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblDictionaryLbl = new System.Windows.Forms.Label();
            ...
            this.Text = "EvilCorp — Dictionary Attack";
            this.Load += new System.EventHandler(this.DictionaryAttackForm_Load);
            ...
            this.tbl.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 28F));  // 3 dict lbl
            this.tbl.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 100F));  // 4 dict textarea (expands)
            ...
            this.tbl.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 66F));  // 9 start+stop
            ...
            this.tbl.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 56F));  // 13 progress+status
            ...
            this.cmbTargetUser.SelectedIndexChanged += new System.EventHandler(this.cmbTargetUser_SelectedIndexChanged);
            this.tbl.Controls.Add(this.cmbTargetUser, 0, 1);
            this.tbl.SetColumnSpan(this.cmbTargetUser, 2);

            // Row 3
            this.lblDictionaryLbl.Name = "lblDictionaryLbl";
            this.lblDictionaryLbl.Dock = System.Windows.Forms.DockStyle.Fill;
            this.tbl.Controls.Add(this.lblDictionaryLbl, 0, 3);
            this.tbl.SetColumnSpan(this.lblDictionaryLbl, 2);

            // Row 4 — textarea expands
            this.txtDictionary.Name = "txtDictionary";
            this.txtDictionary.Dock = System.Windows.Forms.DockStyle.Fill;
            this.txtDictionary.Multiline = true;
            this.txtDictionary.ScrollBars = System.Windows.Forms.ScrollBars.Vertical;
            this.tbl.Controls.Add(this.txtDictionary, 0, 4);
            this.tbl.SetColumnSpan(this.txtDictionary, 2);
            ...
            this.numMaxLength.Maximum = 50;
            this.numMaxLength.Value = 20;
        ...
        private System.Windows.Forms.Label lblDictionaryLbl;
